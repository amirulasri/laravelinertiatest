...
<template>
    <Modal :show="editContactModalOpenState" @close="closeModal">
        <div class="p-6">
            <h2 class="text-lg font-medium text-gray-900">Edit Contact</h2>
            <br>
            <form @submit.prevent="form.put(route('contacts.update', props.contact.id), { onSuccess: () => closeModal() })">
                <div class="space-y-6">
                    <div>
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <PrimaryButton>Update Contact</PrimaryButton>
                    </div>
                </div>
            </form>
        </div>
